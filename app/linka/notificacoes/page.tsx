    ...
    switch (notification.tipo) {
      case NotificationType.NEGOCIO_APROVADO:
        if (notification.data?.business_id) {
          router.push(`/linka/inspecionar-negocio/${notification.data.business_id}`);
        }
        break;
      ...
      case NotificationType.CONEXAO_RECUSADA:
        if (notification.data?.user_id) {
          router.push(`/linka/perfil?id=${notification.data.user_id}&type=${notification.data.user_type}`);
        }
        break;
